...
import com.axellinoanggoro.binar_ch5_topik1.databinding.ActivityCamPermissionBinding
import java.io.File
...
class CamPermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCamPermissionBinding.inflate(layoutInflater)
        ...
        binding.btnTakePhoto.setOnClickListener {
            ...
            val providerFile =
                FileProvider.getUriForFile(
                    this,
                    "com.axellinoanggoro.binar_ch5_topik1",
                    filePhoto
                )
